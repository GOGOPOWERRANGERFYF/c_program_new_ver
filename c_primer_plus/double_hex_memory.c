...
//      转换为负数二补码(正数的二补数就是对应负数的二补码)
//      1111 1111 1111 1111 1111 1111 0111 1110 一补数      
//      1111 1111 1111 1111 1111 1111 0111 1111 二补数(也是对应负数的二补码)      
//
//      但CPU和编译器实际是怎么处理的，我目前还没查到相关深入的资料,只能自己脑补了...  (～￣▽￣)～ 
//      C标准也只是规定了结果,并没规定过程
