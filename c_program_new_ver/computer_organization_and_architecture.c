...
/*
    ...
    说明:*表示重点
        ...
        状态寄存器(status register)
            ZF    zero flag           零标志    当ALU运算结果为0时,ZF=1;否则zf=0
            CF    carry flag          
            NF    negative fag 
            OF    overflow flag       溢出标志  当ALU运算结果最高有效位进位时,OF=1
            SF    sign flag
    ...
    +=================================================================    
        ...
        ==>(0/2待完成任务)数字电路[逻辑表达式/画电路图]和编译原理[语法分析等]20211016标记,以后再深入
		==>(0/2待完成任务)《数字设计和计算机体系结构  原书第2版》P29 组合逻辑设计
